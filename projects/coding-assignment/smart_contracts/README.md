...
By the default the template creates a single `HelloWorld` contract under improved_nft_marketplace folder in the `smart_contracts` directory. To add a new contract:
