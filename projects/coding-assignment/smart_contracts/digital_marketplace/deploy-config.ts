...
import { DigitalMarketplaceClient } from '../artifacts/digital_marketplace/client'
import { TransactionSignerAccount } from '@algorandfoundation/algokit-utils/types/account'

// Below is a showcase of various deployment options you can use in TypeScript Client
export async function deploy() {
  console.log('=== Deploying DigitalMarketplaceClient ===')
  ...
  const appClient = new DigitalMarketplaceClient(
    {
  ...
  // DigitalMarketplaceClient 앱에 판매할 NFT 에셋 송금
  ...
  const buyerAppClient = new DigitalMarketplaceClient(
    {
      resolveBy: 'id',
      sender: buyer,
      id: app.appId,
  ...
  const lateBuyerAppClient = new DigitalMarketplaceClient(
    {
      resolveBy: 'id',
      sender: lateBuyer,
      id: app.appId,
  ...
  async function buyAsset(
    appClient: DigitalMarketplaceClient,
    buyerName: string,
    ...
    // DigitalMarketplaceClient buy 메서드 호출때 구매 비용 지불로 사용할 결제 트랜잭션 생성
    ...
    // 위 결제 트랜잭션과 DigitalMarketplaceClient buy 메서드를 어토믹 트랜잭션으로 동시에 호출
    await appClient.buy(
      {
        buyerTxn: buyNftPay,
        quantity: buyAmount,
  ...
  // 판매자가 DigitalMarketplaceClient 앱을 삭제하며 수익금과 잔여 NFT 에셋을 회수
  ...
  보너스 과제는 총 7문제로 이루어져 있습니다! 밑에 btsScenario 함수 주석을 해제하고 과제를 풀어보세요!
  */
  ...
  //   // 문제 1 시작
  //   const btsAppClient = '여기에 코드를 작성하세요!'
  //   // 문제 1 끝
  ...
  //   // 문제 3 시작
  //   const fanAppClient = '여기에 코드를 작성하세요!'
  //   // 문제 3 끝
  ...
  //   */
  //   // 방탄소년단 콘서트가 인기가 너무 많아서 가격을 10 Algos 올림

  //   // 문제 5 파트1 시작
  //   unitaryPrice = '여기에 코드를 작성하세요!'
  //   ;('여기에 코드를 작성하세요!')
  //   // 문제 5 파트1 끝
  ...
  //   // 방탄소년단 콘서트가 인기가 너무 많아서 또 가격을 10 Algos 올림
